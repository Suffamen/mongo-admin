 ...
 */
export class UxHammerPluginPatch extends ɵHammerGesturesPlugin {
    constructor(@Inject(DOCUMENT) doc: any,
                @Inject(HAMMER_GESTURE_CONFIG) private config: HammerGestureConfig) {
        super(doc, config, {log: () => {}, warn: () => {}});
    }
        ...
        return zone.runOutsideAngular(() => {
            ...
            const callback = function(eventObj: any): void {
                ...
                zone.runGuarded(function() {
                    ...
                    self.triggerUxEvents(eventObj, element, eventName);
                    // handler(eventObj);
                });
            };
     ...
     */
    private triggerUxEvents(eventObj: any, element: HTMLElement, eventName: string): void {
